...
#        'Imaging_laser':     channelConfiguration(22, True, False, False, True),
        'ch5':  channelConfiguration(5,  False,  False, False, True), 
        'ch6':  channelConfiguration(6,  False,  False, False, True),
        'ch7':  channelConfiguration(7,  False,  False, False, True),  
        'ch8':  channelConfiguration(8,  False,  False, False, True),
        'ch9':  channelConfiguration(9,  False,  False, False, True),
        'ch10': channelConfiguration(10, False,  False, False, True),
        'ch11': channelConfiguration(11, False,  False, False, True),
